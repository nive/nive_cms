...
class DefaultMysqlTemplate(PyramidTemplate):
    _template_dir = 'defaultWebsite'
    summary = 'A simple Nive cms website with MySql database'
...
class DefaultPostgreSQLTemplate(PyramidTemplate):
    _template_dir = 'defaultWebsite'
    summary = 'A simple Nive cms website with PostgreSQL database'
    ...
    def pre(self, command, output_dir, vars):
        ...
        vars['param_website'] = """context="PostgreSQL",
            dbName="%(dbcontentname)s",
            host="%(dbhost)s",
            port="%(dbport)s",
            user="%(dbuser)s",
